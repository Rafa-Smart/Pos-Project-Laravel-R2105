...
<div class="modern-card-edit">
    <h3 class="edit-title">➕ Tambah Pelanggan Baru</h3>

    @if ($errors->any())
        <div class="alert alert-danger mb-4">
            <h6 class="fw-bold mb-1">Kesalahan Input:</h6>
            <ul class="mb-0">
    ...
    <form action="{{ route('customer.store') }}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="name" class="form-control modern-input" 
                   value="{{ old('name') }}" placeholder="Masukkan nama lengkap pelanggan" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="email" name="email" class="form-control modern-input" 
                   value="{{ old('email') }}" placeholder="Masukkan alamat email aktif" required>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="text" name="address" class="form-control modern-input" 
                   value="{{ old('address') }}" placeholder="Contoh: Jl. Sudirman No. 10" required>
        </div>
        ...
        <div class="mb-4">
            ...
            <select name="status" class="form-select modern-select" required>
                ...
                {{-- Memperbaiki logika old() untuk status --}}
        ...
        <div class="btn-action-group">
            {{-- Menggunakan btn-success dan class baru untuk konsistensi --}}
            <button type="submit" class="btn btn-success btn-update" style="background-color: #4A90E2; border-color: #4A90E2;">
